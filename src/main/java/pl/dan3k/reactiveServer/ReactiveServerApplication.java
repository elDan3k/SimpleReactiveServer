package pl.dan3k.reactiveServer;
...
public class ReactiveServerApplication {
    ...
    public static void main(String[] args) {
        ReactiveServerApplication application = new ReactiveServerApplication();
        application.serve();
    }
    ...
    private String renderPage(Optional<String> nameInput) {
        String welcome = "Witaj na stronie reaktywnego serwer";
        ...
        return String.format(htmlTemplate, welcome, time);
    }
